...
<body>
    <div class="container">
        ...
        <main id="NonHome">
            ...
            <section>
                <img src="images/Group_Work_min.jpg" class="imgSizer" alt="Students working together">
            </section>
            <!-- First Section On Page -->
            <section>
                <ul class="ListStyleNone">
                    <li>Academic Information
                        <ul class="ListStyleDef">
